...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Order :  IEquatable<Order>, IValidatableObject
    {
        ...
        public Order(int orderId = default(int), string orderCode = default(string), string distributorOrderId = default(string), string statusDelivery = default(string), decimal orderSumWithVat = default(decimal), string statusPay = default(string))
        {
            ...
            if (orderCode == null)
            {
                throw new InvalidDataException("orderCode is a required property for Order and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("distributorOrderId is a required property for Order and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("statusDelivery is a required property for Order and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("orderSumWithVat is a required property for Order and cannot be null");
            }
            else
            {
            ...
            if (statusPay == null)
            {
                throw new InvalidDataException("statusPay is a required property for Order and cannot be null");
            }
            else
            {
