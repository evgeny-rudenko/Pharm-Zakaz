...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class OrderItem :  IEquatable<OrderItem>, IValidatableObject
    {
        ...
        public OrderItem(string uniqueId = default(string), int productId = default(int), string name = default(string), string ean = default(string), string gtin = default(string), decimal vat = default(decimal), decimal price = default(decimal), decimal priceWithVAT = default(decimal), int distributorId = default(int), DateTime expirationDate = default(DateTime), int quantity = default(int), int minOrder = default(int), int multiplicity = default(int), decimal bonus = default(decimal), decimal discount = default(decimal), decimal potentialPriceWithOffers = default(decimal), bool isOffer = default(bool), decimal bonusMaxMonthOrderAmount = default(decimal), decimal potentialPriceTotal = default(decimal), string manufacturer = default(string), decimal productSum = default(decimal), decimal productSumWithVat = default(decimal))
        {
            ...
            if (ean == null)
            {
                throw new InvalidDataException("ean is a required property for OrderItem and cannot be null");
            }
            else
            {
                this.Ean = ean;
            ...
            if (gtin == null)
            {
                throw new InvalidDataException("gtin is a required property for OrderItem and cannot be null");
            }
            else
            {
                this.Gtin = gtin;
            ...
            if (vat == null)
            {
                throw new InvalidDataException("vat is a required property for OrderItem and cannot be null");
            }
            else
            {
                this.Vat = vat;
            ...
            {
                throw new InvalidDataException("priceWithVAT is a required property for OrderItem and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("distributorId is a required property for OrderItem and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("expirationDate is a required property for OrderItem and cannot be null");
            }
            else
            {
            ...
            if (minOrder == null)
            {
                throw new InvalidDataException("minOrder is a required property for OrderItem and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("multiplicity is a required property for OrderItem and cannot be null");
            }
            else
            {
            ...
            if (bonus == null)
            {
                throw new InvalidDataException("bonus is a required property for OrderItem and cannot be null");
            }
            else
            {
                this.Bonus = bonus;
            ...
            if (discount == null)
            {
                throw new InvalidDataException("discount is a required property for OrderItem and cannot be null");
            }
            else
            {
            ...
            if (isOffer == null)
            {
                throw new InvalidDataException("isOffer is a required property for OrderItem and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("manufacturer is a required property for OrderItem and cannot be null");
            }
            else
            {
            ...
            // to ensure "productSum" is required (not null)
            if (productSum == null)
            {
                throw new InvalidDataException("productSum is a required property for OrderItem and cannot be null");
            }
            else
            {
            ...
            // to ensure "productSumWithVat" is required (not null)
            if (productSumWithVat == null)
            {
                throw new InvalidDataException("productSumWithVat is a required property for OrderItem and cannot be null");
            }
            else
            {
                this.ProductSumWithVat = productSumWithVat;
            }
        ...
        /// <summary>
        /// Gets or Sets ProductSum
        /// </summary>
        [DataMember(Name="product_sum", EmitDefaultValue=true)]
        public decimal ProductSum { get; set; }

        /// <summary>
        /// Gets or Sets ProductSumWithVat
        /// </summary>
        [DataMember(Name="product_sum_with_vat", EmitDefaultValue=true)]
        public decimal ProductSumWithVat { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ProductSum: ").Append(ProductSum).Append("\n");
            sb.Append("  ProductSumWithVat: ").Append(ProductSumWithVat).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(OrderItem input)
        {
            ...
            return 
                ...
                (
                    this.ProductSum == input.ProductSum ||
                    (this.ProductSum != null &&
                    this.ProductSum.Equals(input.ProductSum))
                ) && 
                (
                    this.ProductSumWithVat == input.ProductSumWithVat ||
                    (this.ProductSumWithVat != null &&
                    this.ProductSumWithVat.Equals(input.ProductSumWithVat))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ProductSum != null)
                    hashCode = hashCode * 59 + this.ProductSum.GetHashCode();
                if (this.ProductSumWithVat != null)
                    hashCode = hashCode * 59 + this.ProductSumWithVat.GetHashCode();
                return hashCode;
            }
        }
